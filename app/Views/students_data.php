...
<div class="card mb-3">
    ...
    <div class="card-block">
        <form method="POST" action="<?= base_url() ?>/student/<?php echo isset($edit_data) ? "edit/" . $edit_data->id : "add"; ?> ">
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <select type="text" required="required" name="class" class="form-control">
                        <option>Male</option>
                        <option>Female</option>
                    </select>
                </div>
                <div class="col-6">
                    ...
                    <select type="text" required="required" name="parent" class="form-control">
                        <option>Male</option>
                        <option>Female</option>
                    </select>
                </div>
